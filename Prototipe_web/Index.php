        ...
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          ...
          <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
            <li>
              ...
              <i class="bi bi-house"><use xlink:href="#home"></use></i>Inicio</a>
            </li>
            <li>
              <a href="#" class="nav-link text-white">
                <i class="bi bi-bar-chart"></i><use xlink:href="#speedometer2"></use>Centros Comerciales</a>
            </li>
            <li>
              <a href="#" class="nav-link text-white">
              <i class="bi bi-bag-plus-fill"></i><use xlink:href="#table"></use>Categorias</a>
            </li>
            <li>
              <a href="#" class="nav-link text-white">
              <i class="bi bi-tags-fill"><use xlink:href="#grid"></use></i>Ofertas</a>
            </li>
            <li>
